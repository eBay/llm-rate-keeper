...
public class RedisTokenStoreIT {
  ...
  @BeforeEach
  public void setup() {
    redisClient = RedisClient.create("redis://localhost:6379"); // Adjust this to your test Redis server
...
public void testConsumeTokens() {
    ...
    // Validate
    assertTrue(redisTokenStore.hasTokens(clientId, modelId, tokensPerMinuteLimit, tokensPerDayLimit), "Expected true when checking if client has tokens after consuming tokens");
  }
